...
export function mountChatGPTPanel(root: HTMLElement, connected: () => void) {
  ...
  root.innerHTML = `
    ...
    <div id="chatgpt-connected" hidden><p class="connected-label">✓ ChatGPT connected</p><button id="resume-chatgpt">Start browsing</button><button class="quiet-button" id="disconnect-chatgpt">Disconnect ChatGPT</button></div>
